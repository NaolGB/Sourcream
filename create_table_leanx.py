...
required_table_columns = {
    ...
    'BKPF' : ['BELNR', 'BUKRS', 'GJAHR', 'MANDT', 'AWKEY', 'AWTYP', 'BLART', 'BLDAT', 'CPUDT', 'CPUTM', 'USNAM', 'WAERS', 'XREVERSAL', 'XBLNR', 'TCODE'],
    ...
    'EKBE' : ['WRBTR', 'WAERS', 'MENGE', 'BUZEI', 'MANDT', 'BELNR', 'GJAHR', 'VGABE','CPUDT'],
    'EKES' : ['EBELN', 'EBELP', 'EBTYP', 'EINDT', 'ERDAT', 'ETENS', 'EZEIT', 'MANDT', 'MENGE'],
    'EKET' : ['WEMNG', 'MENGE', 'MANDT', 'EBELN', 'EBELP', 'ETENR', 'EINDT', 'BEDAT'],
    ...
    'T052' : ['MANDT', 'ZPRZ1', 'ZPRZ2', 'ZTAG1', 'ZTAG2', 'ZTAG3', 'ZTAGG', 'ZTERM'],
