...
required_table_columns = {
    ...
    'MSEG' : ['BWART', 'BWTAR', 'CPUDT_MKPF', 'CPUTM_MKPF', 'EBELN', 'EBELP', 'ERFME', 'KDAUF', 'KDPOS', 'LBKUM', 'LFBJA', 'LFBNR', 'LGORT', 'LIFNR', 'MANDT', 'MATNR', 'MBLNR', 'MEINS', 'MENGE', 'MJAHR', 'SHKZG', 'SJAHR', 'SMBLN', 'SMBLP', 'USNAM_MKPF', 'VBELN_IM', 'VBELP_IM', 'WAERS', 'WERKS', 'ZEILE'],
